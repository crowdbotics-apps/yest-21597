...
admin.site.site_header = "yest"
admin.site.site_title = "yest Admin Portal"
admin.site.index_title = "yest Admin"

# swagger
api_info = openapi.Info(
    title="yest API",
    default_version="v1",
    description="API documentation for yest App",
)
